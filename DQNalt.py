...
import trfl
from FeedForwardInfeasibleActor import FeedForwardInfeasibleActor

from infeasibilitychecker import InfeasibilityChecker


class DQNFeasible(agent.Agent):
  """DQN agent.
  ...
  def __init__(
    ...
    actor = FeedForwardInfeasibleActor(policy_network, adder, infeasibility_checker=checker)
